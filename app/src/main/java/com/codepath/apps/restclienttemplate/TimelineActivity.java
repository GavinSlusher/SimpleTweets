...
//        Query for existing tweets in the DB (Asynchronously!)
...
//            We know user has selected the compose icon

//            Navigate to the compose activity
            Intent intent = new Intent(this, ComposeActivity.class);
            startActivityForResult(intent, REQUEST_CODE);

//            Return true because we want to 'consume' the menu item here (see documentation)
            return true;
        }
...
//            Update the RV with the new tweet by modifying the data source and updating adapter
                ...
                try {
                    ...
                    AsyncTask.execute(new Runnable() {
                        ...
                        public void run() {
                            ...
                            // then insert tweets (because users have to be populate in users table
                            // so foreign key connection works
